...
export default function Features() {
  return (
    <section className="relative z-10 bg-zinc-50 py-16 md:py-32 dark:bg-transparent">
        ...
        <div className="mx-auto grid gap-4 lg:grid-cols-2">
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="SAE BAJA, hosted by SAE International, is a premier collegiate design competition where students design, build, and race off-road vehicles, gaining hands-on engineering experience and industry exposure."
              />
            </CardHeader>
            ...
            <div className="relative border-t border-dashed max-sm:mb-6">
              ...
              <div className="aspect-76/59 p-1 px-6">
                <DualModeImage
                  darkSrc="/image/hero.png"
                  lightSrc="/images/baja-1.jpg"
          ...
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                icon={Calendar}
                title="SAE A-BAJA & E-BAJA – Autonomous & Electric Mobility Innovation."
                description="SAE A-BAJA and E-BAJA challenge students to build autonomous and electric off-road vehicles, blending real-world engineering, AI-driven systems, and sustainable mobility."
              />
            </CardHeader>

            <CardContent>
              <div className="mask-radial-at-right mask-radial-from-40% mask-radial-[100%_95%] relative max-sm:mb-6">
                <div className="aspect-76/59 overflow-hidden rounded-lg border">
                  <DualModeImage
                    darkSrc="/images/baja-2.jpg"
          ...
          <FeatureCard className="p-6 lg:col-span-2">
            <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold">
              Building Future-Ready Engineers Through E-Mobility.
            </p>
...
const DualModeImage = ({
  ...
  <>
    <Image
      src={darkSrc}
      className={cn("hidden dark:block w-full h-auto rounded-sm", className)}
      alt={`${alt} dark`}
      width={width}
      height={height}
    />
    <Image
      src={lightSrc}
      className={cn("shadow dark:hidden w-full h-auto", className)}
      alt={`${alt} light`}
      width={width}
      height={height}
    />
