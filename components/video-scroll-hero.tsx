      ...
      >
        ...
        <div className="sticky top-0 w-full h-screen flex items-center justify-center z-10">
          ...
          >
            ...
            <motion.div
              className="absolute bottom-0 left-6 bg-background/20 backdrop-blur-[10px] flex items-center justify-center rounded-xl p-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <div className="text-center text-white">
                <motion.h1
                  className="text-md md:text-4xl lg:text-3xl font-bold mb-4 opacity-25"
