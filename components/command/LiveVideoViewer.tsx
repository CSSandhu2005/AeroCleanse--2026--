        ...
        <div className="relative w-full aspect-video bg-black border border-gray-800 rounded-xl overflow-hidden shadow-2xl">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
                ...
                <div className="absolute top-[25%] left-[20%] w-[180px] h-[120px] border-2 border-[#22c55e] bg-[#22c55e]/5">
                    <div className="absolute -top-6 left-0 bg-[#22c55e] text-black text-[10px] px-2 py-0.5 font-black uppercase tracking-wider shadow-lg">Garbage_TYPE_B // 98.4%</div>
                </div>

                <div className="absolute top-[50%] left-[55%] w-[140px] h-[160px] border-2 border-yellow-500/50 bg-yellow-500/5">
                    <div className="absolute -top-6 left-0 bg-yellow-500 text-black text-[10px] px-2 py-0.5 font-black uppercase tracking-wider shadow-lg">Garbage_032 // 82.1%</div>
                </div>
