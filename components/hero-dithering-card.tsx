...
export function CTASection() {
  ...
  return (
    <section className="py-12 w-full flex justify-center items-center px-4 bg-[#000000] md:px-6">
      <div
        className="w-full max-w-7xl relative"
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
        <div className="relative overflow-hidden rounded-[48px] border border-border bg-[#000000] shadow-sm min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
